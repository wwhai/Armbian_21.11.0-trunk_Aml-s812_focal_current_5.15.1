...
fetch_from_repo()
{
	...
	if [[ $changed == true ]]; then
		...
		/*Begin:add by zhaobaoxing for system env compatible*/
		mv /usr/include/libfdt.h /usr/include/libfdt.h.bk
		mv /usr/include/fdt.h /usr/include/fdt.h.bk
		/*End:add by zhaobaoxing for system env compatible*/
